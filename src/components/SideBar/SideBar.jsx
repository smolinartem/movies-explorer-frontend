...
function BurgerMenu({ className, isOpen, handleBurger }) {
  return (
    <section className={`sidebar ${className || ''} ${isOpen ? 'sidebar_opened' : 'sidebar_closed'}`}>
      <div className='sidebar__content'>
        <Navigation className='sidebar__nav' links={BURGER_NAV_CONFIG} handleBurger={handleBurger} />
